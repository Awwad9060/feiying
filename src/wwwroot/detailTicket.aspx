...
<% if (ticketOne != null) { %><title>【<%=ticketOne["fromCityname"]%>到<%=ticketOne["toCityname"]%>机票】_特价往返飞机票预订【飞瀛网(Fei580.com)】</title>
<meta name="Description"  content="【<%=ticketOne["fromCityname"]%>到<%=ticketOne["toCityname"]%>机票】由飞瀛网(fei580.com)为您提供<%=ticketOne["fromCityname"]%>到<%=ticketOne["toCityname"]%>特价机票价格实时查询,在线预订服务,单程或往返为航空公司特价！<%=ticketOne["airname"]%>特价<%=ticketOne["toCityname"]%>机票CNY<%=ticketOne["untaxPrice"]%>。" />

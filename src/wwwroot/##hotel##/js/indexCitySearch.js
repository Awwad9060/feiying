...
var tr01_01 = "#E7E3E7"; //第一行背景顏色
var tr01_02 = "#D6D3D6"; //第二行背景顏色
var tr01_03 = "#FFFFFF";
var tab01 = "#6595D6";  //边框顏色
var kongj;
...
var shcs = new Array("北京首都|PEK|B","上海虹桥|SHA|S","上海浦东|PVG|S","广州|CAN|G","深圳|SZX|S","长沙|CSX|C","北京南苑|NAY|B","武汉|WUH|W","南京|NKG|N","杭州|HGH|H","大连|DLC|D","青岛|TAO|Q","重庆|CKG|C","呼和浩特|HET|H","郑州|CGO|Z","西安|XIY|X","瀋阳|SHE|S","长春|CGQ|C","昆明|KMG|K","乌鲁木齐|URC|W","天津|TSN|T","太原|TYN|T","合肥|HFE|H","福州|FOC|F","南昌|KHN|N","哈尔滨|HRB|H","济南|TNA|J","南寧|NNG|N","海口|HAK|H","贵阳|KWE|G","兰州|LHW|L","银川|INC|Y","西寧|XNN|X");
var qtcs = new Array("阿勒泰|AAT|A","安庆|AQG|A","阿克苏|AKU|A","安康|AKA|A","鞍山|IOB|A","保山|BSD|B","包头|BAV|B","北海|BHY|B","北京首都|PEK|B","北京南苑|NAY|B","长沙|CSX|C","长春|CGQ|C","常德|CGD|C","长治|CIH|C","常州|CZX|C","昌都|BPX|C","朝阳|CHG|C","成都|CTU|C","赤峰|CIF|C","重庆|CKG|C","敦煌|DNH|D","大理|DLU|D","大连|DLC|D","大同|DAT|D","丹东|DDG|D","达县|DAX|D","德宏芒市|LUM|D","迪庆香格里拉|DIG|D","东营|DOY|D","恩施|ENH|E","阜阳|FUG|F","福州|FOC|F","赣州|KOW|G","格尔木|GOQ|G","广元|GYS|G","广州|CAN|G","广汉|GHN|G","桂林|KWL|G","贵阳|KWE|G","怀化|HJJ|H","哈尔滨|HRB|H","海口|HAK|H","海拉尔|HLD|H","哈密|HMI|H","汉中|HZG|H","杭州|HGH|H","合肥|HFE|H","衡阳|HNY|H","和田|HTN|H","呼和浩特|HET|H","黄山|TXN|H","黄巖|HYN|H","惠阳|AHE|H","吉林|JIL|J","济南|TNA|J","吉安|KNC|J","锦州|JNZ|J","景德镇|JDZ|J","荆州、沙市|SHS|J","九江|JIU|J","九寨沟|JZH|J","库尔勒|KRL|K","库车|KCA|K","喀什|KHG|K","克拉玛依|KRY|K","昆明|KMG|K","拉萨|LXA|L","兰州|LHW|L","连云港|LYG|L","梁平|LIA|L","临沂|LYI|L","临沧|LNJ|L","零凌|LLF|L","柳州|LZH|L","瀘州|LZO|Z","洛阳|LYA|L","满州里|NZH|M","梅县|MXZ|M","绵阳|MIG|M","牡丹江|MDG|M","南京|NKG|N","南昌|KHN|N","南充|NAO|N","南寧|NNG|N","南通|NTG|N","南阳|NNY|N","寧波|NGB|N","齐齐哈尔|NDG|Q","且末|IQM|Q","秦皇岛|SHP|Q","青岛|TAO|Q","庆阳|IQN|Q","衢州|JUZ|Z","泉州晋江|JJN|Q","泗水|SUB|Z","三亚|SYX|S","汕头|SWA|S","上海虹桥|SHA|S","上海浦东|PVG|S","鄯善|SXJ|Z","韶关|SHG|S","瀋阳|SHE|S","深圳|SZX|S","石家庄|SJW|S","思茅|SYM|S","塔城|TCG|T","太原|TYN|T","天津|TSN|T","铜仁|TEN|T","万州|WXN|W","潍坊|WEF|W","威海|WEH|W","温州|WNZ|W","武汉|WUH|W","乌鲁木齐|URC|W","武夷山|WUS|W","无锡|WUX|W","梧州|WUZ|W","锡林浩特|XIL|X","西安|XIY|X","西寧|XNN|X","西双版纳景洪|JHG|X","厦门|XMN|X","襄樊|XFN|X","西昌|XIC|X","徐州|XUZ|X","盐城|YNZ|Y","宜昌|YIH|Y","银川|INC|Y","延吉|YNJ|Y","烟台|YNT|Y","延安|ENY|Y","宜宾|YBP|Y","义乌|YIW|Y","伊寧|YIN|Y","榆林|UYN|Y","湛江|ZHA|Z","张家界|DYG|Z","昭通|ZAT|Z","郑州|CGO|Z","舟山|HSN|Z","珠海|ZUH|Z","遵义|ZYI|Z","丽江|LJG|L");
...
tab+= '  <tr align="center">';
tab+= '    <td height="23"'+style1+'>请选择城市(点击城市拼音首字母查找)</td>';
tab+= '  </tr>';
tab+= '  <tr align="center">';
...
for(var ywzm_i=0;ywzm_i<26;ywzm_i++){
	...
	tab+= '<td id=H_"'+ywzm[ywzm_i]+'"><label id="'+ywzm[ywzm_i]+'" style="color:#0000FF; cursor:hand" title="点击查看城市首字母為 '+ywzm[ywzm_i]+' 的城市">'+ywzm[ywzm_i]+'</label></td>';
}
tab+= '        <td id="H_SH"><label id="SH" style="color:#FF0000; cursor:hand" title="点击查看常用城市">常用</label></td>';
...
function turnrowcolor(ss,ls){   //鼠标移动TD背景顏色
 var bc="#FFD373";

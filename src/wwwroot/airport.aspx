<%@ Page Language="C#" AutoEventWireup="true" CodeFile="airport.aspx.cs" Inherits="airport" %>
...
<meta http-equiv="mobile-agent" content="format=xhtml;url=http://m.fei580.com/airport/index.html">
<title>国际机场_全球各地机场,世界机场展示介绍 - 飞瀛网</title>
<meta name="keywords" content="国际机场,全球机场,世界机场" />
<meta name="Description"  content="飞瀛网为您提供全球各地机场介绍，世界机场风景以及国际机场特色，航站楼，登机事项等。飞瀛网，飞，我帮您。专业国际机票预订专家，您出行的好帮手。" />
<meta name="robots" content="index,follow" />
<link rel="canonical" href="http://www.fei580.com/airport.aspx" />
<link rel="alternate" media="only screen and(max-width: 640px)"  href="http://m.fei580.com/airport/index.html">
...
<!--onlinebox start-->  
  ...
  <div class="cad_left">
	  <div class="cad_lefttitle"><strong>中国南方航空</strong><a href="http://www.fei580.com/airline/358.htm" title="" rel="nofollow">更多</a></div>
	  ...
	  <div class="cad_leftline"><img src="http://www.fei580.com/images/cad01.gif" alt="" style="float:right;position:relative;bottom:-1px;right:-1px;margin-top:-69px;z-index:999;" /></div>
	</div>
	...
	<div class="cad_right">
	  ...
	  <img src="http://www.fei580.com/images/cad05.jpg" alt="" style="float:left;" />
	</div>
...
<!--twolinebox start-->  
  ...
  <div class="company_leftthree">

     <div class="cad_search_box addthreeback" title="全球机场查询"><input type="text" class="cad_search_input" id="txtsearch" runat="server" value="中文、英文、二字代码、城市名称" onFocus="if (value =='中文、英文、二字代码、城市名称'){value =''}" onBlur="if (value ==''){value='中文、英文、二字代码、城市名称'}" />
      <asp:Button ID="btnSearchName" CssClass="cad_search_submit" runat="server" OnClick="btnSearchName_Click" /></div>
    	   
	   <div class="company_lefttitle">全球机场列表</div>
	   <div class="company_leftboxtwo">
		<asp:Repeater ID="rptshopnews" runat="server">
	     <HeaderTemplate>
	     <table cellpadding="0" cellspacing="0">
	       <tr>
	         <th align="left">机场中文名称</th>
	         <th align="left">机场英文名称</th>
          ...
          <ItemTemplate>
	       <tr>
	         <td><a href="http://www.fei580.com/airport/<%#Eval("apId")%>.htm"><%#Eval("chName")%></a></td>
	         <td><%#DataBinder.Eval(Container.DataItem, "enName")%></td>
	         <td><%#DataBinder.Eval(Container.DataItem, "cityName")%> </td>
	         <td align="center"><%#DataBinder.Eval(Container.DataItem, "airportCode")%> </td>
	       </tr>
	    </ItemTemplate>
         <FooterTemplate>
         </table>
	...
	<div class="company_leftline">
    <webdiyer:AspNetPager ID="Pager" runat="server" FirstPageText="首页" HorizontalAlign="Right" LastPageText="末页" NextPageText="下一页" PageSize="25" PrevPageText="上一页" ShowPageIndexBox="Always"  SubmitButtonText="转到" OnPageChanged="Pager_PageChanged" UrlPaging="true" AlwaysShow="True"></webdiyer:AspNetPager>
	</div>	   
   </div>
...
<div id="hotcityDiv" style="position:absolute;z-index:999999; background-color:#f3fbff; display:none;">
	...
	<div class="cad_righttwobox">
	  <h2>国际机场推荐</h2>
	  <ul>
	   <%if(yeargoodairline.Count!=0) %>
      <%{ %>
          <% for (int i = 0; i < yeargoodairline.Count; i++)
            {
                System.Data.DataRow goodairline_info = yeargoodairline[i];%>
           <li>&nbsp;&nbsp;<a href="http://www.fei580.com/airport/<%=goodairline_info["apId"]%>.htm" title="<%=goodairline_info["chName"]%>"><%=eap.share.Sys.truncate(goodairline_info["chName"].ToString(),30,"...")%></a></li>
           <%} %>
     <%} %>
	  </ul>
	</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myfeedlist.aspx.cs" Inherits="person_myfeedlist" %>
  ...
  <div class="headerbottom_right">
    ...
    <div style="margin:0px auto;width:953px;">
      ...
      <div class="person_rightbox">
         <span class="yijancss"><a href="myfeedadd.aspx" title="发表意见" class="white">发表意见</a></span>
        <table cellpadding="0" cellspacing="0" class="person_tableone">
          <asp:Repeater ID="rptshopnews" runat="server">
            <HeaderTemplate>
          <tr>
            <th>意见标题</th><th>状态</th><th>发表日期</th><th>操作</th>
          </tr>
               </HeaderTemplate>
            <ItemTemplate>
          <tr>
            <td><%#Eval("title") %></td><td><a class="bluestr"><%#Eval("state").ToString().Trim().Equals("0")?"未解决":"已解决" %></a></td><td><%#Eval("addtime") %></td><td><a href="myfeedinfo.aspx?id=<%#Eval("fId")%>" title="查看详情" class="blackline">查看详情</a></td>
          </tr> 
            </ItemTemplate>
         </asp:Repeater>                                                                       
        </table>

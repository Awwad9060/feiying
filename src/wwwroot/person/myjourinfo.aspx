<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myjourinfo.aspx.cs" Inherits="person_myjourinfo" %>
    ...
    <div style="margin:0px auto;width:953px;">
      ...
      <div class="person_rightbox">
        <table cellpadding="0" cellspacing="6" class="person_tablefive">
          <tr>
            <th>标题：</th>
            <td><input id="title" runat="server" type="text" class="tablefive_text" /><span class="yijancss"><a href="myjouradd.aspx" title="写日记" class="white">写日记</a></span></td>
          </tr>
          <tr>
            <th valign="top">内容：</th>
          ...
          <tr>
            <th></th>
            <td><asp:Button ID="Butt_submit" CssClass="person_submitone"  runat="server" Text="修改日记" OnClick="Butt_submit_Click" /></td>
          </tr>
        </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myjouradd.aspx.cs" Inherits="person_myjouradd" %>
    ...
    <div style="margin:0px auto;width:953px;">
      ...
      <div class="person_rightbox">
        <table cellpadding="0" cellspacing="6" class="person_tablefive">
          ...
          <tr>
            <th></th>
            <td><asp:Button ID="Butt_submit" CssClass="person_submitone"  runat="server" Text="保存日记" OnClick="Butt_submit_Click" /></td>
          </tr>
        </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myticket1.aspx.cs" Inherits="person_myticket1" %>
...
<div class="headerbottom">
  ...
  <div class="headerbottom_right">
    ...
    <ul class="menu_1">
      ...
      <li class="two" style="background:none;"><a href="../service.aspx" title="飞瀛服务">飞瀛服务</a></li>
      ...
      <div class="person_rightbox">
        <table cellpadding="0" cellspacing="0" class="person_tableone">
         <asp:Repeater ID="rptshopnews" runat="server">
          ...
          <tr>
            <th>行程</th><th>航空公司</th><th>出发日期</th><th>回程日期</th><th>电子机票下载</th>
          </tr>
          ...
          <tr>
            <td><%#Eval("fromcity")%>-<%#Eval("tocity")%></td><td><%#Eval("airline")%></td><td><%#Eval("chufa")%></td><td><%#Eval("huicheng")%></td><td style="color:Red;" ><!--<%#Eval("ticketingNumber")%>-->点击下载</td>
          </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myticketing.aspx.cs" Inherits="person_myticketing" %>
      ...
      <div class="person_rightbox">
        <table cellpadding="0" cellspacing="0" class="person_tableone">
         <asp:Repeater ID="rptshopnews" runat="server">
          ...
          <tr>
            <td><%#Eval("fromcity")%>-<%#Eval("tocity")%></td><td><%#Eval("airline")%></td><td><%#Eval("chufa")%></td><td><%#Eval("huicheng")%></td><td style="color:Red;" >共<%#Eval("number")%>个下载</td>
          </tr>

...
<head>
    ...
    <link rel="alternate" media="only screen and(max-width: 640px)"  href="http://m.fei580.com/" >
    ...
    <script type="text/javascript" src="js/ticket.search.index.js"></script>
    ...
    //跳转语句，如果是手机访问就自动跳转到wap.baidu.com页面 
        if (system.win || system.mac || system.xll||system.ipad) { 
            ...
            window.location.href = "http://m.fei580.com/";
        }
    -->
    </script>
    <!--[if lte IE 6]>
...
<body onload="modalClick()">
    ...
    <div class="mainbody">
        ...
        <!--header start-->
        <div class="headertop">
            <span><img src="http://www.fei580.com/images/home.jpg" alt="飞瀛网" /><img src="http://www.fei580.com/images/homeinfor.jpg" alt="飞瀛客服电话" /><strong>国际机票查询</strong>热线：400-885-0663(免费)<!--<span style="color:#f30;font-weight:550;margin-top:-5px;">公告：国庆中秋假期10月1日到10月8日，客服顾问一直在线。祝您国庆中秋快乐平安！</span>--></span>
                ...
                <div class="searchbar">
                    ...
                    <div class="searchform">
                        <div class="searchchoose">
                            <input id="tripType1" type="radio" name="tripType" style="display:none;" value="2" /><%--&nbsp;全部&nbsp;--%>

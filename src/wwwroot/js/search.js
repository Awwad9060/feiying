...
var SetAllSelects = {
    ...
    setSelectStyle: function(obj, idnum, showHeight) {
        ...
        iDiv.onmouseover = function() { iDiv.className = "select_input2 select_input_over2"; }
        iDiv.onmouseout = function() { iDiv.className = "select_input2 select_input_out2"; }
            ...
            if (created != "") {
                ...
                if (liObj.length > 0) {
                    for (var j = 0; j < obj.options.length; j++) {
                        ...
                        liObj[0].setAttribute("liSelected", "selected2");
                    }
                }
            }
        };

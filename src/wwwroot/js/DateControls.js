...
document.writeln('<iframe id=meizzDateLayer name=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 150px; height: 200px; z-index: 9998; display: none"></iframe>');
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #82d71a 1px solid;BORDER-TOP: #82d71a 1px solid;BORDER-LEFT: #82d71a 1px solid;';
strFrame+='BORDER-BOTTOM: #82d71a 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#82d71a bgcolor=#82d71a Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#82d71a style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='        <td width=16 bgcolor=#82d71a align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#82d71a ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#82d71a BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='  <tr Author="wayx"><td width=142 height=100 Author="wayx">';
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#82d71a BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';

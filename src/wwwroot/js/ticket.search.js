...
function TicketSearch(){
    ...
    this.btnSearch.click(function () {
        ...
        // 将值存入 cookie
        $.cookie("fromcity", escape(fromcity), { expires: 7 });
        $.cookie("tocityName", escape(tocityName), { expires: 7 });
        $.cookie("tripType", escape(tripType), { expires: 7 });
        $.cookie("fromtripDate", escape(fromtripDate), { expires: 7 });
        $.cookie("backtripDate", escape(backtripDate), { expires: 7 });
        window.location.href = "searchTicket2.aspx?fromcity=" + fromcity + "&tocityName=" + escape(tocityName) + "&tripType=" + tripType + "&tripDate=" + fromtripDate + "&backDate=" + backtripDate + "";
    }); 

...
if(document.getElementById("tocityName").value==""){
alert("请输入目的地");
return false;
}
}
...
{	
	...
	if(text=="")
	{
	   ...
	   try{
			ajaxRead("http://www.fei580.com/flow_box.aspx?telvalue=" + escape(text), "checksuccess();");
			return;
		}
		catch(e){
			alert('提交失败,出现异常,抱歉!');
...
{	
	...
	if(tCity=="")
	{
	   ...
	   try{
			ajaxRead("http://www.fei580.com/flow_box.aspx?contact=" + escape(contact)+"&fCity="+ escape(fCity)+"&tCity="+ escape(tCity)+"&fDate="+ escape(fDate)+"&tDate="+ escape(tDate), "checkBooksuccess();");
			return;
		}
		catch(e){
			alert('提交失败,出现异常,抱歉!');
...
{	
	...
	if(telephone=="")
	{
	   ...
	   try{
	 		ajaxRead("http://www.fei580.com/book_box.aspx?contact=" + escape(contact)+"&title="+ escape(title)+"&telephone="+ escape(telephone)+"&tId="+tId+"&num="+num+"&tripDate="+ escape(tripDate)+"&backDate="+ escape(backDate)+"&harryGrade="+ escape(harryGrade)+"&otherMess="+ escape(otherMess), "checkTicektBooksuccess();");
			return;
		}
		catch(e){
			alert('提交失败,出现异常,抱歉!');
...
{	
	...
	if(telephone=="")
	{
	   ...
	   try{
	 		ajaxRead("http://www.fei580.com/leave_box.aspx?title=" + escape(title)+"&lType="+ escape(lType)+"&contact="+ escape(contact)+"&telephone="+ escape(telephone)+"&email="+ escape(email)+"&content="+ escape(content), "checkLeavesuccess();");
			return;
		}
		catch(e){
			alert('提交失败,出现异常,抱歉!');
...
{	
	...
	if(telephone=="")
	{
	   ...
	   try{
	 		ajaxRead("http://www.fei580.com/leave_box.aspx?title=" + escape(title)+"&lType="+ escape(lType)+"&contact="+ escape(contact)+"&telephone="+ escape(telephone)+"&email="+ escape(email)+"&content="+ escape(content), "checkObjectsuccess();");
			return;
		}
		catch(e){
			alert('提交失败,出现异常,抱歉!');
...
Compare_show();
 ...
 function login()
 {
  ...
  function checkIds()
        {
            var fromCity1 = document.getElementById("fromCity1").value;

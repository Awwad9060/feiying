<%@ Page Language="C#" AutoEventWireup="true" CodeFile="airline.aspx.cs" Inherits="airline" %>
...
<meta http-equiv="mobile-agent" content="format=xhtml;url=http://m.fei580.com/airline/index.html">
<title>航空公司_国际航空公司,世界航空公司介绍 - 飞瀛网</title>
<meta name="Description"  content="航空公司,国际航空公司,世界航空公司介绍" />
<meta name="keywords" content="航空公司,国际航空公司,世界航空公司介绍" />
<meta name="robots" content="index,follow" />
<link rel="canonical" href="http://www.fei580.com/airline.aspx" />
<link rel="alternate" media="only screen and(max-width: 640px)"  href="http://m.fei580.com/airline/index.html">
...
<script type="text/javascript"  >
    ...
    if (system.win || system.mac || system.xll || system.ipad) {
        ...
        window.location.href = "http://m.fei580.com/airline/index.html";
    }
</script>
<script type="text/javascript">
...
<!--header start-->
<div class="headertop"><span><img src="http://www.fei580.com/images/home.jpg" alt="Home" /><img src="http://www.fei580.com/images/homeinfor.jpg" alt="" />国际、国内机票服务热线：400-885-0663(免费)</span></div>
...
<!--twolinebox start-->  
  <div class="clearbox">  
     ...
     <div class="cad_search_box" title="全球航空公司查询"><input runat="server" type="text" class="cad_search_input" id="txtsearch" value="中文、英文、二字代码、城市名称" onFocus="if (value =='中文、英文、二字代码、城市名称'){value =''}" onBlur="if (value ==''){value='中文、英文、二字代码、城市名称'}" />
         <asp:Button ID="btnSearchName" CssClass="cad_search_submit" runat="server" OnClick="btnSearchName_Click" />
     </div>
    
	   
	   <div class="company_lefttitle"><h2>航空公司列表</h2></div>
	   <div class="company_leftboxtwo">
		 <asp:Repeater ID="rptshopnews" runat="server">
	     <HeaderTemplate>
	     <table cellpadding="0" cellspacing="0">
	       <tr>
	         <th align="left">航空公司中文名称</th>
	         <th align="left">航空公司英文名称</th>
	         <th align="left">所属国家</th>
	         <th>二字代码</th>
	       </tr>
	      </HeaderTemplate>
          <ItemTemplate>
	       <tr>
	         <td><a href="http://www.fei580.com/airline/<%#Eval("aid")%>.htm"><%#Eval("chName")%></a></td>
	         <td><%#DataBinder.Eval(Container.DataItem, "enName")%></td>
	         <td><%#DataBinder.Eval(Container.DataItem, "nation")%> </td>
	         <td align="center"><%#DataBinder.Eval(Container.DataItem, "airlineCode")%> </td>
	       </tr>
	    </ItemTemplate>
         <FooterTemplate>
         </table>
  ...
  <div class="cad_righttwo">
    ...
    <div class="onelinebox_leftboxone">
      <ul class="onelinebox_leftboxonetitle onelinebox_leftboxonetitle_soso1">
        ...
        <li class="two" id="right2" >特价机票</li>
        <li class="three" id="right3" >特价酒店</li>
      </ul>
...
<div id="hotcityDiv" style="position:absolute;z-index:999999; background-color:#f3fbff; display:none;">
	...
	<div class="cad_righttwobox">
	  <h2>各地区最佳航空公司</h2>
	  <ul>
	   <%if (citygoodairline.Count != 0) %>
      <%{ %>
          <% for (int i = 0; i < citygoodairline.Count; i++)
            {
                System.Data.DataRow goodairline_info = citygoodairline[i];%>
           <li><img src="http://www.fei580.com/<%=goodairline_info["smallPic"]%>" width="24px" height="18px" alt="<%=goodairline_info["chName"]%>" /><a href="http://www.fei580.com/airline/<%=goodairline_info["aId"]%>.htm" title="<%=goodairline_info["chName"]%>"><%=eap.share.Sys.truncate(goodairline_info["chName"].ToString(),20,"...")%></a></li>
           <%} %>
     <%} %>
	  </ul>

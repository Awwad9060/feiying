...
<div class="flight-time"><span class="datetime">起飞：<?php echo get_custom_value('deptime'); ?></span><span class="datetime">到达：<?php echo get_custom_value('arrtime'); ?></span></div>
<div class="flight-deline"><p><?php $airport = get_custom_value('transPort'); if(!empty($airport)){ echo '[中转]-'.$airport.'-[飞行] '.get_custom_value('flytime');} else { echo '[直飞]-[飞行] '.get_custom_value('flytime'); } ?></p></div>
</div>
<?php } else { ?>
<div class="flytimeinfo">
<div class="flight-time transfer-go"><span class="datetime">起飞：<?php echo get_custom_value('deptime'); ?></span><span class="datetime">到达：<?php echo get_custom_value('arrtime'); ?></span></div>
<div class="flight-deline"><p><?php $airport = get_custom_value('transPort'); if(!empty($airport)){ echo '[中转]-'.$airport.'-[飞行] '.get_custom_value('flytime');} else { echo '[直飞]-[飞行] '.get_custom_value('flytime'); } ?></p></div>
<div class="flight-time transfer-back"><span class="datetime">起飞：<?php echo get_custom_value('ardeptime'); ?></span><span class="datetime">到达：<?php echo get_custom_value('ararrtime'); ?></span></div>
<div class="flight-deline"><p><?php $airport = get_custom_value('transPort'); if(!empty($airport)){ echo '[中转]-'.$airport.'-[飞行] '.get_custom_value('arflytime');} else { echo '[直飞]-[飞行] '.get_custom_value('arflytime');; } ?></p></div>
</div>
<?php } ?>
<div class="flight-port">
<div class="airport">
...
<?php $rtimed = get_custom_value('rtimed'); if(!empty($rtimed)){ echo '<div class="rtimed">机位紧张</div>';} ?>
</div>
<div class="clear"></div>
<div class="buylink">

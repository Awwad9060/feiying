<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quanList.aspx.cs" Inherits="quanList" %>
...
<head>
<title><%=typeName%> - 飞瀛网（国际商旅专家）</title>
...
<body>
    ...
    <div class="headerbottom">
      ...
      <div class="headerbottom_right">
        ...
        <div class="header_nav">您现在位置：<a href="http://www.fei580.com/" title="">飞瀛网</a>&gt;<a href="http://www.fei580.com/quan.aspx" title="">飞瀛圈</a>&gt;&nbsp;<%=typeName%>列表</div>
      </div>
    </div>
    <!--header end-->
    ...
    <div style="margin:0px auto;width:965px;position:relative;">
      <div class="qiuanadmin_newslist_left">
	    ...
	    <div class="qiuanadmin_newslist_leftbox">
	      <ul class="newslist_vstitle qiuanadmin_list">
	            <li class="<%=(typeId==1)? "one":"two" %>"><a href="http://www.fei580.com/quanList.aspx?typeId=1" style="color:<%=(typeId==1)? "#167FC3":"#9A9A9A" %>">攻略游记</a></li>
	            <li class="<%=(typeId==2)? "one":"two" %>"><a href="http://www.fei580.com/quanList.aspx?typeId=2" style="color:<%=(typeId==2)? "#167FC3":"#9A9A9A" %>">旅游点评</a></li>
	            <li class="<%=(typeId==3)? "one":"two" %>"><a href="http://www.fei580.com/quanList.aspx?typeId=3" style="color:<%=(typeId==3)? "#167FC3":"#9A9A9A" %>">图片故事</a></li>
	            <li class="<%=(typeId==4)? "one":"two" %>"><a href="http://www.fei580.com/quanList.aspx?typeId=4" style="color:<%=(typeId==4)? "#167FC3":"#9A9A9A" %>">旅游问答</a></li>
			    <li class="<%=(typeId==5)? "one":"two" %>"><a href="http://www.fei580.com/quanList.aspx?typeId=5" style="color:<%=(typeId==5)? "#167FC3":"#9A9A9A" %>">寻找结伴</a></li>
	       </ul>
          ...
          <div class="qiuan_twoline_ulthree qiuanadmin_newslist_leftboxone">
	         ...
	         <asp:Repeater ID="quanlist" runat="server">
	           <ItemTemplate>
	        <ul>
		       <li class="one"><a href="http://www.fei580.com/trip/<%# Eval("aId") %>.htm" target="_blank"><%#DataBinder.Eval(Container.DataItem, "title")%></a></li>
      ...
      <!--boxright start-->
	      <div class="newsdoc_right">
	        ...
	        <!--div class="newsdoc_righttitlethree"><strong>讨论区热点</strong><a href="http://quan.fei580.com" title="">更多&nbsp;&gt;</a></div>

...
public partial class receive : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        X509Certificate2 cert = new X509Certificate2(Server.MapPath("/99bill/99bill[1].cert.rsa.20140728.cer"), "");
		...
		//此处做商户逻辑处理
                ...
                Response.Write("<result>1</result>" + "<redirecturl>http://www.fei580.com/99bill/show.aspx?msg=success</redirecturl>");
            }
            else
            {
                //以下是我们快钱设置的show页面，商户需要自己定义该页面。
                Response.Write("<result>1</result>" + "<redirecturl>http://www.fei580.com/99bill/show.aspx?msg=error</redirecturl>");
            }
        }
        else
        {

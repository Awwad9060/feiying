<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedbackadd.aspx.cs" Inherits="console_person_feedbackadd" %>
<%@ Register assembly="FredCK.FCKeditorV2" namespace="FredCK.FCKeditorV2" tagprefix="FCKeditorV2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>查看或修改会员反馈信息</title>
   ...
   <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" id="TABLE1">
          ...
          <tr>
                <td align="center" bgcolor="#F6F6F6" style="width: 413px">
                    状态：</td>
                <td height="25" align="left" bgcolor="#F6F6F6" style="width: 839px">
               <input id="stateu"  name="state" runat="server" value="0" type="radio" />未解决&nbsp;&nbsp;&nbsp;&nbsp;<input id="statee" name="state" runat="server" value="1" type="radio" />已解决
               </td>
                <td bgcolor="#F6F6F6" style="width: 253px">
                  </td>
            </tr>
            ...
            <tr>
                <td align="center" bgcolor="#F6F6F6" style="height: 27px" colspan="3">
                 ...
                 <input name="Submit3" type="button" style="height: 23px;"onclick="location.href='feedbacklist.aspx'" value="返 回" />
                    </td>
            </tr>
            <tr>

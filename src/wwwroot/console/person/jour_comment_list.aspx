<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jour_comment_list.aspx.cs" Inherits="console_person_jour_comment_list" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>会员文章评论信息</title>
                ...
                <td>
                    <div>
                        ...
                        <table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" style="background-color: #E7E7E7">
                            <tr>
                                <td style="width: 20%; height: 25px;" align="center">
                                    会员文章标题：
                                </td>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                  <a href="../../quanDetail.aspx?aId=<%# Eval("artId") %>" target="_blank"><%# Eval("title")%></a>
                                                </td>
                                                <td>    
                                                  <%# Eval("comtcontent") %>
                                                </td>

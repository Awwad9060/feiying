<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedbacklist.aspx.cs" Inherits="console_person_feedbacklist" %>
                                            ...
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  ...
                                                  <td>
                                                   <%#DataBinder.Eval(Container.DataItem, "state").ToString().Trim().Equals("0")?"未解决":"已解决"%> 
                                                </td>
                                                 <td>
                                                   <a style="color:Red" href="feedbackadd.aspx?id=<%# Eval("fId") %>">修改</a>&nbsp;
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

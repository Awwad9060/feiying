...
public partial class console_person_jourlist : System.Web.UI.Page
{
    ...
    protected void GetShopNewslist()
    {
        ...
        string str = @"select top 100 percent * from FY_member_article  where 1=1 ";
    ...
    protected void btndel_Click(object sender, EventArgs e)
    {
        ...
        str.Append("delete from FY_member_article where aId in (" + Request.Form["chk"] + ");");
        ...
        using (SqlTransaction trans = conn.BeginTransaction())
        {
            try
            {
                ...
                trans.Commit();
                scripthelp.AlertAndRedirect("操作成功！", "jourlist.aspx", this.Page);
            }
            catch
            {
                trans.Rollback();
                scripthelp.AlertAndRedirect("操作失败！", "jourlist.aspx", this.Page);
            }
            finally
            {
                conn.Close();
    ...
    protected void checkBut_Click(object sender, EventArgs e)
    {
        ...
        str.Append("update FY_member_article set isCheck=1 where aId in (" + Request.Form["chk"] + ");");
    ...
    protected void uncheckBut_Click(object sender, EventArgs e)
    {
        ...
        str.Append("update FY_member_article set isCheck=0 where aId in (" + Request.Form["chk"] + ");");
    ...
    protected void recBut_Click(object sender, EventArgs e)
    {
        StringBuilder str = new StringBuilder();

        str.Append("update FY_member_article set isRec=1 where aId in (" + Request.Form["chk"] + ");");
    ...
    protected void noRecBut_Click(object sender, EventArgs e)
    {
        StringBuilder str = new StringBuilder();

        str.Append("update FY_member_article set isRec=0 where aId in (" + Request.Form["chk"] + ");");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="airport_list.aspx.cs" Inherits="console_airport_airport_list" %>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                <td>
                                                    <input id="chk" name="chk" type="checkbox" style="border: 0" value="<%# Eval("apId") %>" />
                                                </td>
                                                <td>
                                                   <%#DataBinder.Eval(Container.DataItem, "airPortCode")%> 
                                                </td>
                                                <td>
                                                    <%#Eval("chName")%>
                                                </td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                   <a style="color:Red" href="airport_add.aspx?id=<%# Eval("apId") %>">修改</a>&nbsp;
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

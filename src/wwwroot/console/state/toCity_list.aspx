<%@ Page Language="C#" AutoEventWireup="true" CodeFile="toCity_list.aspx.cs" Inherits="console_state_toCity_list" %>
<%@ Register assembly="AspNetPager" namespace="Wuqi.Webdiyer" tagprefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>到达城市列表信息</title>
                ...
                <td>
                    <div>
                        <table align="center" cellpadding="4" cellspacing="1" border="0" width="100%" class="toptable grid">
                            <tr>
                                <td height="25"  width="150"  style="color:Red;">到达城市信息管理</td>    
                            </tr>
                        </table>
                        <table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" style="background-color: #E7E7E7">
                            <tr>
                                 <td colspan="2" align="left" valign="middle" class="Enquiries" style="padding-left:20px;">到达城市中文名：
                                  <input  id="txttypeName" runat="server" type="text" size="20" />      
                                   ...
                                   <asp:Button ID="btnSelect" runat="server" Height="23" Text="查 询" OnClick="btnSelect_Click" /> 
                                       &nbsp;&nbsp; &nbsp;&nbsp;
                                   <input name="Submit3" type="button" style="height:23px" id="add" runat="server" onclick="location.href='toCity_add.aspx'" value="添 加" />
                                </td>
                            </tr>
                        </table>

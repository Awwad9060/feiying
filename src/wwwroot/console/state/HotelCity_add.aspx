<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelCity_add.aspx.cs" Inherits="console_state_HotelCity_add" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
     <title>编辑酒店城市信息</title>
        ...
        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" id="TABLE1">
            ...
            <tr>
                ...
                <td align="left" bgcolor="#F6F6F6" style="height: 27px">                    
                 ...
                 <input name="Submit3" type="button" onclick="location.href='HotelCity_list.aspx'" value="返 回"    style="height: 23px;"/>
                </td>

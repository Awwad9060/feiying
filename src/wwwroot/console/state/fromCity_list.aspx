<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fromCity_list.aspx.cs" Inherits="console_state_fromCity_list" %>
<%@ Register assembly="AspNetPager" namespace="Wuqi.Webdiyer" tagprefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>出发城市列表信息</title>
                ...
                <td>
                    <div>
                        <table align="center" cellpadding="4" cellspacing="1" border="0" width="100%" class="toptable grid">
                            <tr>
                                <td height="25"  width="150"  style="color:Red;">出发城市信息管理</td>    
                            </tr>
                        </table>
                        <table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" style="background-color: #E7E7E7">
                            <tr>
                                 <td colspan="2" align="left" valign="middle" class="Enquiries" style="padding-left:20px;">出发城市中文名：
                                  <input  id="txttypeName" runat="server" type="text" size="20" />      
                                   ...
                                   <asp:Button ID="btnSelect" runat="server" Height="23" Text="查 询" OnClick="btnSelect_Click" /> 
                                       &nbsp;&nbsp; &nbsp;&nbsp;
                                   <input name="Submit3" type="button" style="height:23px" id="add" runat="server" onclick="location.href='fromCity_add.aspx'" value="添 加" />
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:DataGrid ID="dgList" AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
                                        ...
                                        <Columns>
                                            <asp:TemplateColumn HeaderText="选   择">
                                                <ItemTemplate>
                                                    <input id="chk" name="chk" type="checkbox" style="border: 0" value="<%# Eval("fId") %>" />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateColumn HeaderText="操　　作">
                                                <ItemTemplate>
                                                    <%# Operator_State(Convert.ToInt32(Eval("fId"))) %>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            </asp:TemplateColumn>
                                        </Columns>

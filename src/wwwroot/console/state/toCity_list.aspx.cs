...
using eap.share;
public partial class console_state_toCity_list : System.Web.UI.Page
{
    int bigId = 0;
    ...
    protected void GetEntlist(int bigId)
    {
        ...
        string str = "select a.*,b.chName as stateName from FY_ToCity as a  left join FY_State as b on a.sId =b.sId where 1=1";
    ...
    public string Operator_State(int Id)
    {
        ...
        {
            return str_name = " <a href='toCity_add.aspx?id=" + Id + "'>编辑</a>";
    ...
    protected void btndel_Click(object sender, EventArgs e)
    {
        ...
        str.Append("delete from FY_ToCity where tId in (" + Request.Form["chk"] + ")");
        ...
        using (SqlTransaction trans = conn.BeginTransaction())
        {
            try
            {
                ...
                trans.Commit();
                scripthelp.AlertAndRedirect("删除到达城市信息成功!", "toCity_list.aspx", this.Page);
            ...
            catch
            {
                ...
                scripthelp.Alert("删除到达城市信息失败!", this.Page);

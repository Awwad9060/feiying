...
public partial class console_airline_airline_list : System.Web.UI.Page
{
    ...
    protected void GetShopNewslist()
    {
        ...
        {
            str += " and chName like '%" + txtsearch.Value.Trim() + "%' or airlineCode like '%" + txtsearch.Value.Trim() + "%'";
        }
    ...
    protected void btndel_Click(object sender, EventArgs e)
    {
        ...
        str.Append("delete from FY_Airline where aId in (" + Request.Form["chk"] + ");");
        ...
        using (SqlTransaction trans = conn.BeginTransaction())
        {
            ...
            {
                trans.Rollback();
                scripthelp.AlertAndRedirect("操作失败！", "airline_list.aspx", this.Page);
            }
            finally
            {
                conn.Close();

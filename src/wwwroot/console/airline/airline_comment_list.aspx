<%@ Page Language="C#" AutoEventWireup="true" CodeFile="airline_comment_list.aspx.cs" Inherits="console_airline_airline_comment_list" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>航空公司评论信息</title>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                  <a href="../../airlineDetail.aspx?aId=<%# Eval("airlineId") %>" target="_blank"><%# Eval("chName") %></a>
                                                </td>
                                                <td>    
                                                  <%# Eval("name") %>
                                                </td>

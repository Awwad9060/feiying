<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticketBook1_list.aspx.cs" Inherits="console_book_ticketBook1_list" %>
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  <a style="color:blue" href="ticketBook1_info.aspx?id=<%# Eval("bId") %>" >查看</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticketBook_list1.aspx.cs" Inherits="console_book_ticketBook_list1" %>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                   <a style="color:blue" href="../../showticket.aspx?tId=<%# Eval("tId") %>" target="_blank"><%# Eval("tId") %></a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  <a style="color:blue" href="ticketBook_info1.aspx?id=<%# Eval("bId") %>" >查看</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

...
public partial class console_book_ticketBook1_list1 : System.Web.UI.Page
{
    ...
    protected void GetShopNewslist()
    {
        ...
        string str = @"select top 100 percent * from FY_TicketBook1 ";
        str += " order by FY_TicketBook1.bId desc";

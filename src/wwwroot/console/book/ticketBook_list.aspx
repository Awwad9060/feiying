<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticketBook_list.aspx.cs" Inherits="console_book_ticketBook_list" %>
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  <a style="color:blue" href="ticketBook_info.aspx?id=<%# Eval("bId") %>" >查看</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

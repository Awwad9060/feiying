...
public partial class console_book_ticketBook2_list2 : System.Web.UI.Page
{
    ...
    protected void GetShopNewslist()
    {
        ...
        string str = @"select top 100 percent * from FY_TicketMobileBook ";
        str += " order by FY_TicketMobileBook.bId desc";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticketBook_info1.aspx.cs" Inherits="console_book_ticketBook_info1" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" id="ticket_table">
            ...
            <tr>
                <td align="right" bgcolor="#F6F6F6" style="height: 27px" colspan="3">
                 <input name="Submit3" type="button" style="height: 23px;"onclick="location.href='ticketBook_list1.aspx'" value="返 回" />
                    </td>
            </tr>
            <tr>

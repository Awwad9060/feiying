<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticketing_list.aspx.cs" Inherits="console_ticketing_ticketing_list" %>
                            ...
                            <asp:Repeater ID="rptshopnews" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr style="background-color: #F6F6F6; text-align: center;">
                                        <td>
                                           <input id="chk" name="chk" type="checkbox" style="border: 0" value="<%# Eval("cId") %>" />
                                        </td>
                                        <td>
                                           <%#Eval("ticketingId")%>
                                        </td>
                                        <td>
                                           <%#Eval("fromcity")%>-<%#Eval("tocity")%>
                                        </td>
                                            <td>
                                          <%#Eval("airline")%>
                                        </td>
                                  <td>
                                      ...
                                      <td>
                                          ...
                                          <td>
                                          <%#Eval("ticketingNumber")%>
                                        </td>
                                         <td>
                                           <%#Convert.ToInt32(Eval("ticketingState")) == 0 ? "失效" : "有效"%>
                                        </td>
                                         <td>
                                           <a style="color:Red" href="http://www.fei580.com/fileload.aspx?path=/<%#Eval("ticketingPath")%>">下载</a>&nbsp;
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr bgcolor="#E7E7E7">
                                    ...
                                    <td  style="width: 42%; height: 28px;" align="left">
                                        <asp:Button ID="btndel" runat="server" Text="删 除" Height="23px" OnClientClick="return check()"  OnClick="btndel_Click" />
                                    </td>

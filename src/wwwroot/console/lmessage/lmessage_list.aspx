<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lmessage_list.aspx.cs" Inherits="console_lmessage_lmessage_list" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>客户投诉建议列表</title>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                <td>
                                                    <input id="chk" name="chk" type="checkbox" style="border: 0" value="<%# Eval("lId") %>" />
                                                </td>
                                                <td style=" cursor:hand" title="<%# Eval("title") %>" >
                                                  <%# Eval("title")%>
                                                </td>
                                                <td>
                                                  <%# Eval("lType").ToString().Trim() == "服务建议" ? "<span style=\"color:Green\">" + Eval("lType") + "</span>" : "<span style=\"color:red\">" + Eval("lType") + "</span>"%>
                                                </td>
                                                <td>
                                                  <%# Eval("contact")%>
                                                </td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  <a style="color:blue" href="lmessage_info.aspx?id=<%# Eval("lId") %>" >查看</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>

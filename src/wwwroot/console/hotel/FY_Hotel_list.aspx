<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FY_Hotel_list.aspx.cs" Inherits="console_hotel_FY_Hotel_list" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>基础酒店列表管理</title>
                ...
                <td>
                    <div>
                        ...
                        <table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" style="background-color: #E7E7E7">
                            <tr>
                                <td style="width: 10%; height: 25px;" align="center">
                                    酒店城市：
                                </td>
                                ...
                                <td style="width: 27%; height: 25px;">
                                    <select id="sel_pass" runat="server" >
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                              ...
                                              <td><img src="../../<%#DataBinder.Eval(Container.DataItem, "picPath")%>" alt="" width="80" height="60" /></td>
                                                 
                                                <td>
                                                   <%#DataBinder.Eval(Container.DataItem, "HotelName")%>  
                                                </td>
                                                   <td>
                                                   <%#DataBinder.Eval(Container.DataItem, "chName")%>  
                                                </td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                  <%-- <a style="color:Red" href="FY_Hotel_pic.aspx?hotelId=<%# Eval("hId") %>">图片集</a>
                                                   &nbsp;&nbsp;--%>
                                                   <a style="color:Red" href="FY_Hotel_add.aspx?id=<%# Eval("hId") %>">修改</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                        <tr bgcolor="#E7E7E7">
                                            ...
                                            <td  style="width: 50%; height: 28px;" align="left">
                                                <asp:Button ID="btncheck" runat="server" Text="设为置顶" Height="23px" OnClientClick="return check()"
                                                    OnClick="btncheck_Click" />
                                                    <asp:Button ID="btncancelchk" runat="server" Text="取消置顶" Height="23px" OnClientClick="return check()" OnClick="btncancelchk_Click"
                                                   />
                                                <asp:Button ID="btnrecom" runat="server" Text="设为推荐" Height="23px" OnClientClick="return check()"
                                                    OnClick="btnrecom_Click" />
                                                    <asp:Button ID="btncancelrecom" runat="server" Text="取消推荐" Height="23px" OnClientClick="return check()" OnClick="btncancelrecom_Click"
                                                    />
                                                
                                                <asp:Button ID="btndel" runat="server" Text="删 除" Height="23px" OnClientClick="return check()"
                                                    OnClick="btndel_Click" />
                                            </td>
                                            <td align="right" bgcolor="#E7E7E7" style="color: #000000; height: 28px; width: 42%;">

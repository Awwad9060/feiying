...
public partial class console_hotel_FY_Hotel_comment_list : System.Web.UI.Page
{
    ...
    protected void GetShopNewslist()
    {
        ...
        string str = @"select top 100 percent FY_Hotel_comment.*,FY_Hotel.HotelName,tmember.Mem_LoginName from FY_Hotel_comment left join FY_Hotel on FY_Hotel_comment.hId=FY_Hotel.hId left join tmember on FY_Hotel_comment.memberId=tmember.Mem_ID where 1=1 ";

        if (txtsearch.Value.Trim() != "")
        {
            str += " and FY_Hotel.HotelName like '%" + txtsearch.Value.Trim() + "%'";
        }

        str += " order by FY_Hotel_comment.addtime desc";
    ...
    protected void btndel_Click(object sender, EventArgs e)
    {
        ...
        str.Append("delete from FY_Hotel_comment where hId in (" + Request.Form["chk"] + ")");

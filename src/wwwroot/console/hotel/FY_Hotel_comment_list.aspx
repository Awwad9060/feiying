<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FY_Hotel_comment_list.aspx.cs" Inherits="console_hotel_FY_Hotel_comment_list" %>
                                    ...
                                    <asp:Repeater ID="rptshopnews" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #F6F6F6; text-align: center;">
                                                ...
                                                <td>
                                                  <a href="../../hotelinfo_<%# Eval("hId") %>.htm" target="_blank"><%# Eval("HotelName")%></a>
                                                </td>
                                                 <td>    
                                                  <%#Eval("type").ToString()=="0"?"商务":"旅游" %>/<%# Eval("year") %>-<%# Eval("mouth") %>
                                                </td>
                                                <td>    
                                                  <%# Eval("name") %>
                                                </td>

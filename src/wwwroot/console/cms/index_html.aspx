<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index_html.aspx.cs" Inherits="console_cms_index_html" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>生成Fei580.com首页内容</title>
                ...
                <td>
                    <div>
                        ...
                        <table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" style="background-color: #E7E7E7"> 
                            <tr>
                                <td style="width: 20%; height: 51px; text-align:center;">生成Fei580.com首页
                                   </td>

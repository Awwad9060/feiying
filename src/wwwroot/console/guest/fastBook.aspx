<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fastBook.aspx.cs" Inherits="console_guest_fastBook" %>
                                ...
                                <td style="width: 100%;">
                                    <asp:DataGrid ID="adminlist" AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="联系信息">
                                                <ItemTemplate>
                                                    <%# Eval("contact")%>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            ...
                                            <asp:TemplateColumn HeaderText="出发城市">
                                              ...
                                              <asp:TemplateColumn HeaderText="到达城市">
                                                <ItemTemplate>
                                                   <%# Eval("tCity")%>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            ...
                                            <asp:TemplateColumn HeaderText="出发日期">
                                                <ItemTemplate>
                                                   <%# Eval("fDate")%>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            ...
                                            <asp:TemplateColumn HeaderText="返回日期">
                                                <ItemTemplate>
                                                   <%# Eval("tDate")%>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            ...
                                            <asp:TemplateColumn HeaderText="预定日期">
                                                <ItemTemplate>
                                                   <%# Eval("bDate")%>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            ...
                                            <asp:TemplateColumn HeaderText="操　　作">
                                                <ItemTemplate>
                                                    <a href="?Oper=del&Id=<%#Eval("bId")%>" onclick="return isdel()">删除</a>  
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="B" />
                                            </asp:TemplateColumn>
                                        </Columns>
